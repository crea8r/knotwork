...
from core.mcp.contracts.work_packet_context import LoadedWorkPacketContext, serialize_message


def build_assets_work_packet(
    *,
    ...
    context_hints = [
        ...
        {"kind": "query", "value": "channel.assets"} if context.assets else None,
