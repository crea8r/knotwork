...
import { FilePlus, FolderPlus, GitBranch, MonitorPlay, Pencil, FolderInput, Trash2 } from 'lucide-react'
...
export default function FileContextMenu({
  target, x, y, onClose,
  onNewFile, onNewPresentation, onNewWorkflow, onNewFolder, onRename, onMoveTo, onDelete,
  hideRename = false,
  ...
  if (onNewPresentation) {
    items.push({
      ...
      onClick: () => { onNewPresentation(folder); onClose() },
    })
  }
  if (onNewFolder) {
    items.push({
