...
import { File, FileText, FileType2, Folder, GitBranch, Image, Lock, MonitorPlay } from 'lucide-react'
...
interface Props {
  ...
  onNewPresentation: (folder: string) => void
...
function FileTypeIcon({ fileType }: { fileType: string }) {
  ...
  if (fileType === 'presentation') return <MonitorPlay size={14} className="flex-shrink-0 text-amber-500" />
...
export default function FolderBrowser({
  ...
  onNewFile, onNewPresentation, onNewWorkflow, onNewFolder,
    ...
    <div className="flex flex-col h-full">
      ...
      {contextMenu && (
        <FileContextMenu target={contextMenu.target} x={contextMenu.x} y={contextMenu.y}
          ...
          onNewFile={allowNewFile ? onNewFile : undefined}
          onNewPresentation={allowNewFile ? onNewPresentation : undefined}
          onNewWorkflow={allowNewWorkflow ? onNewWorkflow : undefined}
          onNewFolder={allowNewFolder ? onNewFolder : undefined}
