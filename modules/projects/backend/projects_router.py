...
from modules.assets.backend.knowledge_schemas import CreateFolderRequest, FileVersionOut, KnowledgeFolderOut, KnowledgeRestoreRequest, RenameFolderRequest, SuggestionOut
...
async def upload_project_file_preview(
    ...
    from modules.assets.backend.knowledge_conversion import VIDEO_EXTS, suggested_path
    from modules.assets.backend.knowledge_conversion_vision import convert_with_vision
