...
from .channels_models import Channel, ChannelAssetBinding, ChannelEvent, ChannelMessage, ChannelSubscription, DecisionEvent
from .channels_schemas import ChannelCreate, ChannelMessageCreate, ChannelUpdate, DecisionEventCreate
...
async def get_or_create_asset_chat_channel(
    ...
    *,
    ...
    from modules.assets.backend import knowledge_folder_service as folder_service
