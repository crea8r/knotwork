...
async def _record_decision_event(
    ...
    from .channels_schemas import DecisionEventCreate, ChannelMessageCreate

    actor_type = data.actor_type or "human"
    channel_id = data.channel_id
    if channel_id is None:
        channel_id = await core_channels.find_workflow_channel_for_run(db, esc.run_id)  # type: ignore[attr-defined]
    payload = {
