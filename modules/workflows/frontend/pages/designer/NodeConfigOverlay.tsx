...
export default function NodeConfigOverlay({
  ...
  return (
    <>
      {/* Desktop side panel */}
      <div data-ui="workflow.editor.inspector.desktop" className="hidden h-full min-h-0 border-l border-gray-200 bg-white md:flex" style={{ width: 320, flexShrink: 0, flexDirection: 'column', overflow: 'hidden' }}>
        <div data-ui="workflow.editor.inspector.desktop.content" style={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
          <NodeConfigPanel {...panelProps} />
        </div>
      </div>

      {/* Mobile full-screen overlay */}
      <div data-ui="workflow.editor.inspector.mobile" className="fixed inset-0 z-50 flex flex-col bg-white md:hidden">
        ...
        <div data-ui="workflow.editor.inspector.mobile.content" className="min-h-0 flex-1 overflow-hidden">
          <NodeConfigPanel {...panelProps} />
        </div>
      </div>
    </>
