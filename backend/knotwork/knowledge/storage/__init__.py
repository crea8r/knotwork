...
from knotwork.config import StorageBackend, settings
from knotwork.knowledge.storage.adapter import StorageAdapter
...
def get_storage_adapter() -> StorageAdapter:
    ...
    if settings.storage_adapter == StorageBackend.S3:
        from knotwork.knowledge.storage.s3 import S3Adapter
