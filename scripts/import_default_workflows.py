...
from libs.auth.backend.models import User  # noqa: F401
...
BOOTSTRAP_ROOT = ROOT / "modules" / "workflows" / "bootstrap"
CATALOG_PATH = BOOTSTRAP_ROOT / "default_workflows.json"
HANDBOOK_ROOT = BOOTSTRAP_ROOT / "handbook"
HANDBOOK_MANIFEST_PATH = BOOTSTRAP_ROOT / "handbook_manifest.json"
