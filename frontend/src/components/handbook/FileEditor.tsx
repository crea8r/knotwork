...
import { EditorWorkspaceBody, EditorWorkspaceTabs } from '@/components/editor/EditorWorkspace'
import { getAssetEditorPlugin } from '@/components/editor/plugins/registry'
