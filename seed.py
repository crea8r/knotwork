...
async def ensure_demo_projects(db, ws, graph) -> None:
    ...
    from modules.communication.backend.channels_schemas import ChannelCreate
    from modules.communication.backend.channels_service import create_channel
    from modules.projects.backend.projects_models import Objective, Project, ProjectStatusUpdate
    from modules.projects.backend.projects_schemas import ObjectiveCreate, ProjectCreate
    from modules.projects.backend.projects_service import create_objective, create_project
